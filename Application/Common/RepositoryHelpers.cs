...
namespace Team5.Infrastructure.Common
{
    ...
    public static class RepositoryHelpers
    {
        ...
        /// <returns></returns>
        /// <exception cref="ArgumentNullException"></exception>
        public static IQueryable<T> WhereCondition<T>(this IQueryable<T> query, Expression<Func<T, bool>>? whereCondition) where T : class
        {
            if (query == null)
                throw new ArgumentNullException(nameof(query));
        ...
        /// <returns></returns>
        /// <exception cref="ArgumentNullException"></exception>
        public static IQueryable<TResult> SelectField<TSource, TResult>(this IQueryable<TSource> query, Expression<Func<TSource, TResult>> selector) where TSource : class where TResult : class
        {
            if (query == null)
                throw new ArgumentNullException(nameof(query));
        ...
        /// <returns></returns>
        /// <exception cref="ArgumentNullException"></exception>
        private static IQueryable<T> SelectField<T>(this IQueryable<T> query, string[] selectedFields) where T : class
        {
            if (query == null)
                throw new ArgumentNullException(nameof(query));
        ...
        /// <returns></returns>
        public static IQueryable<TSource> ApplyConditions<TSource>(this DbSet<TSource> dbSet, QueryHelper<TSource> queryHelper, bool isAsNoTracking = true) where TSource : class
        {
        ...
        /// <param name="queryHelper"></param>
        /// <returns></returns>
        public static IQueryable<TResult> ApplyConditions<TSource, TResult>(this DbSet<TSource> dbSet, QueryHelper<TSource, TResult> queryHelper, bool isAsNoTracking = true) where TSource : class where TResult : class
        {
            IQueryable<TSource> query = dbSet;
        ...
        static Expression<Func<TSource, TResult>> CreateProjection<TSource, TResult>() where TSource : class where TResult : class
        {
        ...
        public static Expression<Func<SetPropertyCalls<TEntity>, SetPropertyCalls<TEntity>>> GetSetPropertyCalls<TEntity, TDto>(this TDto dto) where TEntity : class where TDto : class
        {
